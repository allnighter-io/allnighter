...
final class ContractRegistryTests: XCTestCase {
    ...
    func testM1CommandSetMatchesMilestoneBoundary() {
        ...
        let expected: Set<String> = [
            "docs", "menu", "menu show", "chrome", "doctor", "doctor explain", "doctor handoff", "doctor silence", "detect", "capacity", "bootstrap", "install-cli", "uninstall", "version", "feedback", "update", "billing", "billing checkout",
            ...
            "sweep start", "sweep resume", "sweep status",
