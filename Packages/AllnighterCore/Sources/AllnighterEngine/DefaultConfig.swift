...
public enum DefaultConfig {
    public static let workers: [Worker] = [
        ...
        Worker(id: "worker_gemini", displayName: "Gemini Flash", modelLabel: "gemini-flash", driverId: "gemini", role: .member),
    ...
    private static let manifestJSON: [String] = [
        ...
        #"{"id":"gemini","manifestVersion":1,"displayName":"Gemini Flash (manual)","kind":"manual_paste"}"#,
