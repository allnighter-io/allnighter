...
public enum ModelCatalog {
    ...
    public static func modelFamily(_ modelId: String, driverId: String? = nil) -> String {
        ...
        case "model_fable", "model_opus", "model_sonnet",
            ...
            return "claude"
        case "model_gpt_sol", "model_cursor_gpt_sol", "model_gpt_astra", "model_gpt_terra", "model_gpt_luna",
             "model_gpt_54", "model_gpt_54_mini", "model_gpt_spark":
            return "gpt"
        case "model_agy_gptoss":
            return "gpt_oss"
        case "model_grok", "model_grok_45", "model_grok_46", "model_grok_composer_25_fast", "model_cursor_grok_45", "model_cursor_grok_46":
            return "grok"
    ...
    public static func defaultFreshModels() -> [Model] {
        builtIns.map { def in
            Model(
                ...
                effortVariants: def.effortVariants, family: def.family,
                generation: def.generation, resolvedPinId: def.resolvedPinId)
        }
    }
