...
public struct ContractRegistry: Sendable, Equatable, Codable {
    ...
    public enum OutputSchema: String, Codable, Sendable {
        case none, teamRunJSON, doctorResult, coordinatorHealth, teamStartResponse, teamStatusResponse, teamCancelResponse, pendingItemJSON, pendingListJSON, modelListJSON, floorRun, errorEnvelope, markdown, contractDoc
    }
