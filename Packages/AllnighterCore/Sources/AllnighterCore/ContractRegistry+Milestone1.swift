...
public extension ContractRegistry {
    ...
    static let m1Commands: [CommandSpec] = [
        ...
        CommandSpec(
            ...
            milestone: .m1,
            trigger: "Use when the user wants one worker or team to answer or act in a project repo root (chat / named-model ask / Default Team / --no-wait to keep going after you step away).",
    ...
    static let m1Errors: [ErrorSpec] = [
        ...
        ErrorSpec("AGENT_FAILED", ruleId: "agent.failed", agentAction: "Inspect `workerId` and source error; failed worker remains visible.", requiresManual: false, retryable: true, explain: "One worker failed. The failure is shown, never hidden; other workers may still have answered. Retry the worker or proceed with partial results."),
