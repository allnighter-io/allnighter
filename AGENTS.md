...
| Capacity strip, `alln capacity`, warm pool, menu-bar resident | [`Capacity_Warm_Bench.md`](Capacity_Warm_Bench.md) — Dock app owns silent schedule + socket; menu bar / warm PTY not v1; CLI cutover blocked on `alln` rebuild |
