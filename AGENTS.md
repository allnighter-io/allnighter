...
| OpenCode local / Ollama; Context Firewall; Second Mac | Local Ollama seats: `docs/phases/OpenCode_Local_Ollama_Seats.md` (ladder shipped 2026-08-13; remaining Claude-local A, §11 B, OCL-S05). Packets 2–3 still code unauthorized: `docs/phases/Context_Firewall.md`, `docs/phases/Second_Mac_Bench.md`. |
