...
| OpenCode local / Ollama; Context Firewall; Second Mac | Open packets 1–3 (code unauthorized): `docs/phases/OpenCode_Local_Ollama_Seats.md`, `docs/phases/Context_Firewall.md`, `docs/phases/Second_Mac_Bench.md`. |
