...
| OpenCode empty `incomplete_no_final_message` after idle; parser race; stall mid-`task`; seat timeout 2× | Open packet: `docs/phases/OpenCode_Turn_Capture_Hardening.md` (OCH-S01…S04). Empty-idle mitigate AgentOS `9579bb8`. Code SSOT: AgentOS `OpenCodeSSEParser`, `OpenCodeServeClient`, `OpenCodeRoutingWorkerRunner` |
