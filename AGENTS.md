...
| Capacity strip, `alln capacity`, warm pool, menu-bar resident | [`Capacity_Warm_Bench.md`](Capacity_Warm_Bench.md) — Core/Engine/Mac done; CLI cutover blocked on `alln` rebuild; resident = scheduled one-shot + socket (not persistent PTYs first) |
