...
| Capacity strip, `alln capacity`, stale %, warm pool, menu-bar resident | Open packet: `docs/phases/Capacity_Warm_Bench.md` — target SSOT `CapacityWarmPool`, `CapacityFetch`, `CapacityResidentService`; today `CapacityDisplayAcquisition`, `CapacityProbe` |
