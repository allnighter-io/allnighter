...
| Model/skill/agent/team vocabulary | `docs/workflows/Product_Vocabulary.md` + code catalogs; machine-layer `worker*` retirement packet: `docs/phases/Worker_To_Agent_Migration.md` |
