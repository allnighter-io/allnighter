...
| Capacity strip, `alln capacity`, warm pool, menu-bar resident | [`Capacity_Warm_Bench.md`](Capacity_Warm_Bench.md) — S00a spike → S00b honesty cut; plan-time off; warm pool appendix |
