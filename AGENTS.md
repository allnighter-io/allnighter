...
| Agent surface, `alln bootstrap` activation, help/menu routing (MCP retired 2026-07-16) | `docs/phases/Menu_Not_Router.md` — live `alln menu --json` is the selection front door; `alln bootstrap` prints the four-rule paste-ready host context; CLI is the only agent surface (`docs/phases/MCP_Retirement.md` historical) |
| Agent front door: `install-cli`, `bootstrap`, live menu selection | Front door V1 Complete — archived `docs/archive/phases/Agent_Front_Door.md` (gate 1) + archived `docs/archive/phases/Agent_Onboarding.md` (gate 2). Gate 3 router retired — SSOT `docs/phases/Menu_Not_Router.md` (tombstoned archive: `docs/archive/phases/Agent_Intent_Router.md`) |
