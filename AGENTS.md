...
| Model/skill/agent/team vocabulary | `docs/workflows/Product_Vocabulary.md` + code catalogs; historical machine-layer cutover: `docs/archive/phases/Worker_To_Agent_Migration.md` |
