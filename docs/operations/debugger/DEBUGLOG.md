...
Proof: `swift test --disable-sandbox --package-path Packages/AllnighterCore --filter 'PortabilityHygieneTests|ResidentExecutionRendezvousTests|ResidentExecutionBrokerTests|ResidentExecutionContractTests'` passed 14/14. This proves broker contract and portability only, not TCC behavior. Full packet: `docs/operations/debugger/2026-07-24-resident-run-tcc-PACKET.md`.
