...
| --- | --- | --- | --- |
| `Packages/AllnighterCore` models + engine | never | - | Shared types, Codable, team/worker orchestration |
| `Packages/AllnighterCore` CLI tools | never | - | ProveCLI, AllnighterCLI entry points |
| `Apps/AllnighterMac` orchestration | never | - | App shell, team UI, driver configs |
