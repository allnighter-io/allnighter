...
| 2026-08-03 | `Apps/AllnighterMac/Sources/TeamEditorView.swift` | 1,036 LOC — scout done (`TeamEditorView-split.md`); CM-S22+ queued | xcodebuild test AllnighterMac | med | open | CM-S22 EditSkillView extract |
