...
| 2026-08-03 | `Apps/AllnighterMac/Sources/ThreadView.swift` | **done** CM-S08–S20 — 1238→272 LOC shell + 7 row/chrome files | xcodebuild test AllnighterMac | low | done | — |
| 2026-08-03 | `Apps/AllnighterMac/Sources/TeamEditorView.swift` | **done** CM-S22–S23 — 1036→625 LOC shell + TeamDraft + EditSkillView; CM-S24 deferred | xcodebuild test AllnighterMac | med | done | CM-S24 when roster work resumes |
