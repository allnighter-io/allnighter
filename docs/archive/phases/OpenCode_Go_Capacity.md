...
> Killed specifically: the Chrome-cookie -> AES-GCM store -> HTTPS fetch -> SSR
> tokenizer chain. A bespoke credential subsystem to feed a capacity strip is the
> clearest instance of the creep this ruling names. Never started; no code lost.
