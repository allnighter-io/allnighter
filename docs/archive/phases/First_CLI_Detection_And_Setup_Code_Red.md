...
- **Home empty-state CLI pills (FLCS — CLOSED):** [`../archive/phases/First_Launch_CLI_Strip.md`](../archive/phases/First_Launch_CLI_Strip.md)
  — marketing chips are setupCards + StatusDot; not capacity; tap → openCLISetup
