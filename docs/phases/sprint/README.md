...
start SC-S05. The forward contract was
[`Alln_Serve_Hotfixes.md`](../../archive/phases/Alln_Serve_Hotfixes.md), now
archived complete (2026-08-11).
...
These remain historical evidence only. ASR superseded them and is itself
archived.

## Alln serve recovery (ASR) — ARCHIVED 2026-08-11

All ASR work orders are complete and moved to
[`docs/archive/phases/sprint/alln-serve/`](../../archive/phases/sprint/alln-serve/).
The packet is archived at
[`docs/archive/phases/Alln_Serve_Hotfixes.md`](../../archive/phases/Alln_Serve_Hotfixes.md).

Do not resume ASR here. **§10.1 R1 — the 2026-08-09 LWCR root cause — was never
identified** and is re-homed to `docs/operations/debugger/DEBUGLOG.md`. Code SSOT
is `ServeLifecycle`, `ServeDaemon`, `ServeStatusJSON`, `CanonicalCLIInstall`;
vocabulary is `Product_Vocabulary.md` §Background scheduler.
