...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Run_Lifecycle_Reliability.md`](Run_Lifecycle_Reliability.md) | **HARDENED (K3) — S00 evidence/RCA first; blocks IR-S02 + Onboarding V1** | Kimi K3 GO-WITH-EDITS applied (kill settlement, transition table, `--retry-of`, identity-alive). Wire shape freezes at S01; do not product-patch until S00 reproduces field signatures. |
