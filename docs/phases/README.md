...
| [`Serve_Continuity.md`](Serve_Continuity.md) | **OPEN — v2.5; founder YES login+stable; SC-S04a next** | Stage stable CLI copy, then enable/disable agent, then install-cli refresh transaction. |
