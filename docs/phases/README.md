...
| [`Design_Lane.md`](Design_Lane.md) | **Draft law** — founder intent locked 2026-07-26; render-capture unbuilt | What Design team means: code mockup → host render → screenshot (not Midjourney). Diffusion is explicit opt-in only. |
