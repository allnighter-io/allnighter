...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Team_Run_Receipt.md`](Team_Run_Receipt.md) | **Draft — visual grammar G1–G13** (16:9 poster retired); not Ready until S00+S00b | Scrollable decision receipt; Lead Call + phosphor seat status; Partial = needs you; above-the-fold glance, content-intrinsic height. |
