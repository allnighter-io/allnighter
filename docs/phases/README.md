...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Run_Lifecycle_Reliability.md`](Run_Lifecycle_Reliability.md) | **FINAL; S00 DELIVERED 2026-07-19 — S01 unblocked; blocks IR-S02 + Onboarding V1** | Spec closed (K3 + PM pass). S00 evidence landed: incident packet (`docs/debuglog/RLR_incident_packet.md`), spawn-site matrix (`docs/phases/rlr/Spawn_Site_Matrix.md`), fake CLI + gated-red `RunLifecycleTwoProcess` tests reproducing the terminal-lie and `fanning_out` signatures. Wire shape freezes at S01. |
