...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Team_Run_Receipt.md`](Team_Run_Receipt.md) | **Draft — Spec Review Min EC1DCCAF… hardened**; not Ready until S00+S00b | Screenshot-native decision card (`card show`); two theses (growth kill ≠ product kill); field ledger + design/proof gates before S01; crypto/hosted/Buzz cut. |
