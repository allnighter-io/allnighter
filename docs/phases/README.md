...
| --- | --- | --- |
| [`Capacity_Warm_Bench.md`](Capacity_Warm_Bench.md) | **OPEN — start CWB-S00** | Honest cold path first: kill disk/history lies, PTY-only live-or-unknown, loud Refresh. Warm pool S01+. |
