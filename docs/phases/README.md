...
| [`Crew_Understaffed_Signal.md`](Crew_Understaffed_Signal.md) | **OPEN — not started** | CLI→CLI: dead seat on a live multi-seat run must shout on `alln show` (`crew_understaffed`). No reseat / new commands. Origin: 2026-08-07 PM `--seat` dogfood. |
