...
| [`Observed_Usage_On_Receipts_And_Live_Status.md`](Observed_Usage_On_Receipts_And_Live_Status.md) | **OPEN — v3 (2026-07-30)** | Terminal receipts first: per-answer usage on TeamRunJSON + honest CLI blame; one slice (S01). Live pilot/relay status deferred to separate contract. Upstream: AgentOS `Observed_Token_Usage_Capture.md`. |
