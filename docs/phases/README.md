...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Worker_Skill_Sharing.md`](Worker_Skill_Sharing.md) | **Direction locked** | **Worker** on team roster (skill + model); shared **skill** + `skill.md`; no fork-on-save; edit-worker UI (model → skill → skill.md). Phase 1: skill overrides (B1). |
