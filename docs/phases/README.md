...
| [`Probe_Freshness.md`](Probe_Freshness.md) | **v8 — founder B; PF-S03b probe smoke next** | Option A shipped; founder B (2026-08-09) authorizes serve periodic `full: true` probe. Sprint: [`sprint/probe-freshness/PF-S03b-probe-smoke-scheduler.md`](sprint/probe-freshness/PF-S03b-probe-smoke-scheduler.md). |
