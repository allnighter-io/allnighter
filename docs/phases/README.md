...
| [`Design_Lane.md`](Design_Lane.md) | **Locked law** — Spec Review Ready 2026-07-26; capture wiring = DL-S0 | What Design team means: built surface → host screenshot (not Midjourney). Diffusion is explicit opt-in only. |
