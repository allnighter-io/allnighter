...
| [`Serve_Continuity.md`](Serve_Continuity.md) | **OPEN — v2.6; SC-S04a done; SC-S04b next** | Enable/disable product LaunchAgent on staged binary; then install-cli refresh (S02). |
