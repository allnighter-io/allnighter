...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Team_Run_Receipt.md`](Team_Run_Receipt.md) | **Draft — reshaped after Growth Min E900A4BC…**; not started | Screenshot-native decision card first (`alln team open`); TRR-S00 measure gate; crypto/hosted/Buzz slices cut or deferred. Private by default; reproduceCommand as proof line. |
