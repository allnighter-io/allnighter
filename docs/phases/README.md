...
| [`Menu_Envelope_Compression.md`](Menu_Envelope_Compression.md) | **OPEN — design recommendation** | Usability #1, size distant second. **Incorporate only:** plain JSON default, honest/raised size gate, omit-null + round capacity. **Reject:** gzip, columnar/string-pool, template patterns, tier-2 offload. |
