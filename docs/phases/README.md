...
| [`Probe_Freshness.md`](Probe_Freshness.md) | **v8 — PF-S03b SHIPPED (`fed8f447`); ARCHIVE READY pending promote** | Founder B serve probe smoke landed. Closeout: promote laws + reconcile CWB Dock-only lock + archive. |
