...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Team_Run_Receipt.md`](Team_Run_Receipt.md) | **Draft — G1–G13**; readability first; not Ready until S00+S00b | Polished scrollable team receipt; desktop + mobile; Lead Call + phosphor seats; Partial = needs you; not a viral poster. |
