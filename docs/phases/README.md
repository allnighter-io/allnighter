...
| [`OpenCode_Turn_Capture_Hardening.md`](OpenCode_Turn_Capture_Hardening.md) | **OPEN — Ready to code (v2)** | Flash `5BBA6E13` + Pro `54CFCA2B` harden. OCH-S01…S04: actor parser last-only, harden reconcile, busy/idle-defer+clock, shared timeout budget. |
