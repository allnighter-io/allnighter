...
| [`Serve_Continuity.md`](Serve_Continuity.md) | **OPEN — v2.1; SC-S00a done (H1 refuted post-bootstrap); SC-S00 → Kimi K3** | Doctor/health fail-closed on wedged LA next. Lifecycle + install-cli + demand heal follow. |
