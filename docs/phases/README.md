...
| Doc | Status | Purpose |
| --- | --- | --- |
| [`Team_Run_Receipt.md`](Team_Run_Receipt.md) | **Draft — visual grammar G1–G13 locked**; not Ready until S00+S00b | Screenshot-native 16:9 decision card; Lead Call + phosphor seat status; Partial = needs you; Ready = no hue; no glow on settled card. |
