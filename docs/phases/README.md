...
| [`Agent_Visible_Queuing.md`](Agent_Visible_Queuing.md) | **OPEN — incident-driven** | Agent status honesty (v3): queued/unobserved/progressing/stalled decision contract — not silent FIFO or lying `running`. AVQ-S01–S03 (honest status, ps recovery, bootstrap). Origin: 2026-07-30; refined via Grok then Codex Terra through `alln`. |
