...
| [`CLI_Install_Documents_TCC_Adhoc_Waive.md`](CLI_Install_Documents_TCC_Adhoc_Waive.md) | **OPEN — v2 WAIVE** | Ad-hoc CDHash dogfood; rebuild_cli belt OK; residual = uninstall `alln` from Documents cwd. DeepSeek `8B500118`. No Developer ID cold-install smoking gun. |
