...
| [`Observed_Usage_On_Receipts_And_Live_Status.md`](Observed_Usage_On_Receipts_And_Live_Status.md) | **OPEN — v4 (2026-07-30)** | **Live pilot/relay status** is the primary deliverable (duration + optional tok, stream-primary liveness). S01 contract, **S02 live (hero)**, S03 terminal receipt + help. Upstream: AgentOS `Observed_Token_Usage_Capture.md`. |
