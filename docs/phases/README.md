...
| [`Observed_Usage_On_Receipts_And_Live_Status.md`](Observed_Usage_On_Receipts_And_Live_Status.md) | **OPEN — v2 (2026-07-30)** | After AgentOS token capture: duration always + tokens when reported on receipts and live pilot/relay status; blame silent CLIs explicitly. Three slices (S01 contract, S02 artifact+help, S03 live). Upstream: AgentOS `Observed_Token_Usage_Capture.md`. |
