...
| [`Serve_Continuity.md`](Serve_Continuity.md) | **OPEN — v2.2; SC-S00a+S00 done; SC-S01 → Kimi K3** | Next: migrate/remove orphan LA (`serve repair`). No SMAppService register until founder ruling. |
