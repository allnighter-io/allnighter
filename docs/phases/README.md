...
| [`CLI_Install_Documents_TCC_Adhoc_Waive.md`](CLI_Install_Documents_TCC_Adhoc_Waive.md) | **OPEN — v1 WAIVE proposed** | Post-`ProtectedCWDEscape`: remaining Documents popup on uninstall/rebuild is ad-hoc CDHash dogfood, not signed-product install. Founder: ignore if unsigned-dev. |
